    ...
    public function actionAdd(){
        ...
        if($_SERVER['REQUEST_METHOD'] == "POST"){
            ...
            if($article->save()){
                ...
                if($body->save()){
                    echo '<script>alert("添加成功");location.href="article/content/add"</script>';
                }else{
//                    var_dump($body->getErrors());
                    echo '<script>alert("内容添加失败");location.href="article/content/add"</script>';
                }

            }else{
//                var_dump($article->getErrors());
                echo '<script>alert("添加失败");location.href="article/content/add"</script>';
            }
