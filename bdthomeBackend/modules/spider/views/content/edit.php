            ...
            <div class="portlet light portlet-fit portlet-form bordered">
                ...
                <div class="portlet-body">
                    ...
                    <form name="form1" id="form1" action="" method="post" class="form-horizontal">
                        ...
                        <input type="hidden" name="thisid" value="<?= $article['id'] ?>" >
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input name="label" type="text" class="form-control" value="" /> </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <textarea class="wysihtml5 form-control" rows="4" name="describe" data-error-container="#editor1_error"><?= $desc ?></textarea>
                        ...
                        <div class="form-actions">
                            <div class="row">
                                <div class="col-md-offset-2 col-md-10">
                                    <input type="submit" class="btn green" value="发布到 大数据之家">
