...
<div class="row">
    <div class="col-md-12">
        <div class="note note-success">
            <h4 class="block">站点分类</h4>
            <p> 在这里可以添加、删除、编辑站点的分类，站点的分类为一级分类。 </p>
        </div>
        <!-- BEGIN PORTLET-->
        <div class="portlet light bordered">
            <div class="portlet-body">
                <table class="table table-hover table-striped table-bordered">
                    <tr>
                        <td> <a class="btn btn-outline dark" data-toggle="modal" href="#responsive"> 添加分类 </a> </td>
                        <td>
                            排序
                        </td>
                        <td>
                    ...
                    <form class="form-horizontal" role="form" name="form1" action="/website/category/sort" method="post">
                ...
                <div id="responsive" class="modal fade" tabindex="-1" data-width="500" style="text-align: center;">
                    ...
                    <form class="form-horizontal" role="form" name="form1" action="/website/category" method="post">
        ...
        foreach ($array as $k=>$v ) {
            ...
            echo '
                 <tr>
                    ...
                    <td><input type="text" class="form-control" name="sortNum" id="sortNum" value="'.$v['sort_num'].'"></td>
                    <td>
