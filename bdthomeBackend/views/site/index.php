...
$this->registerCssFile('@web/style/global/plugins/bootstrap-daterangepicker/daterangepicker.min.css');
$this->registerCssFile('@web/style/global/plugins/morris/morris.css');
$this->registerCssFile('@web/style/global/plugins/fullcalendar/fullcalendar.min.css');
$this->registerCssFile('@web/style/global/plugins/jqvmap/jqvmap/jqvmap.css');
...
<!-- BEGIN PAGE TITLE-->
<h1 class="page-title"> 管理面板
    <small>统计、图表、最近的事件和报告</small>
</h1>
<!-- END PAGE TITLE-->
<!-- END PAGE HEADER-->
                        ...
                        <div class="mt-comments">
                            <div class="mt-comment">
                                <div class="mt-comment-img">
                                    <img src="../asspages/media/users/avatar1.jpg" /> </div>
                            ...
                            <div class="mt-comment">
                                <div class="mt-comment-img">
                                    <img src="../asspages/media/users/avatar6.jpg" /> </div>
                                <div class="mt-comment-body">
                                    <div class="mt-comment-info">
                            ...
                            <div class="mt-comment">
                                <div class="mt-comment-img">
                                    <img src="../asspages/media/users/avatar8.jpg" /> </div>
                                <div class="mt-comment-body">
                                    <div class="mt-comment-info">
                            ...
                            <div class="mt-comment">
                                <div class="mt-comment-img">
                                    <img src="../asspages/media/users/avatar4.jpg" /> </div>
                                <div class="mt-comment-body">
                                    <div class="mt-comment-info">
                ...
                <div class="tab-content">
                        ...
                        <div class="mt-actions">
                            <div class="mt-action">
                                <div class="mt-action-img">
                                    <img src="../asspages/media/users/avatar10.jpg" /> </div>
                            ...
                            <div class="mt-action">
                                <div class="mt-action-img">
                                    <img src="../asspages/media/users/avatar3.jpg" /> </div>
                                <div class="mt-action-body">
                                    <div class="mt-action-row">
                                        <div class="mt-action-info ">
                                            <div class="mt-action-icon ">
                            ...
                            <div class="mt-action">
                                <div class="mt-action-img">
                                    <img src="../asspages/media/users/avatar2.jpg" /> </div>
                                <div class="mt-action-body">
                                    <div class="mt-action-row">
                                        <div class="mt-action-info ">
                                            <div class="mt-action-icon ">
                            ...
                            <div class="mt-action">
                                <div class="mt-action-img">
                                    <img src="../asspages/media/users/avatar7.jpg" /> </div>
                                <div class="mt-action-body">
                                    <div class="mt-action-row">
                                        <div class="mt-action-info ">
                                            <div class="mt-action-icon ">
                            ...
                            <div class="mt-action">
                                <div class="mt-action-img">
                                    <img src="../asspages/media/users/avatar9.jpg" /> </div>
                                <div class="mt-action-body">
                                    <div class="mt-action-row">
                                        <div class="mt-action-info ">
                                            <div class="mt-action-icon ">
                    ...
                    <div class="tab-pane" id="tab_actions_completed">
                        ...
                        <div class="mt-actions">
                            ...
                            <div class="mt-action">
                                <div class="mt-action-img">
                                    <img src="../asspages/media/users/avatar5.jpg" /> </div>
                                <div class="mt-action-body">
                                    <div class="mt-action-row">
                                        <div class="mt-action-info ">
                                            <div class="mt-action-icon ">
        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body" id="chats">
                <div class="scroller" style="height: 525px;" data-always-visible="1" data-rail-visible1="1">
                    <ul class="chats">
                        <li class="out">
                            <img class="avatar" alt="" src="../asslayouts/layout/img/avatar2.jpg" />
                            <div class="message">
                        ...
                        <li class="in">
                            <img class="avatar" alt="" src="../asslayouts/layout/img/avatar1.jpg" />
                            <div class="message">
                                <span class="arrow"> </span>
                        ...
                        <li class="out">
                            <img class="avatar" alt="" src="../asslayouts/layout/img/avatar3.jpg" />
                            <div class="message">
                                <span class="arrow"> </span>
