                                ...
                                <div class="blog-single-content bordered blog-container">
                                    <div class="blog-single-head">
                                        ...
                                        <div class="blog-single-head-date">
                                            ...
                                            <a href="javascript:;"><?= $article['vsits'] ?></a>&nbsp;&nbsp;
                                            <i class="icon-calendar font-blue"></i>
                                            <a href="javascript:;"><?= date("Y-m-d",$article['addtime']) ?></a>
                                        </div>
                                    </div>
                                    ...
                                    <!-- 表情 -->
                                    <div id="cyEmoji" role="cylabs" data-use="emoji" sid="article_<?= $article['id']?>"></div>
                                    ...
                                    <script type="text/javascript">
                                        window.changyan.api.config({
                                            appid: 'cyt4F837f',
                                            conf: 'prod_ab4797fe1293180f9b71ce146ea3028c'
                                        });
                                    </script>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="blog-single-sidebar bordered blog-container">
                                    ...
                                    <div class="blog-single-sidebar-recent">
                                        <h3 class="blog-sidebar-title uppercase">热门新闻</h3>
